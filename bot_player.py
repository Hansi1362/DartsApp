...
def start(name1, name2, rounds, mode, bot_lvl):
    ...
    t1_p2 = t.Entry(two_player_root, font=workwith.font_two, width=3, textvariable=t1_text)
    t2_p2 = t.Entry(two_player_root, font=workwith.font_two, width=3, textvariable=t2_text)
    t3_p2 = t.Entry(two_player_root, font=workwith.font_two, width=3, textvariable=t3_text)
    ...
    def ok2():
        throw, is_winning, points_bot = workwith.calc(t1_p2.get(), t2_p2.get(), t3_p2.get(), points_left_p2.get(), 2)
        ...
        if is_winning:
            ...
            tts.text_to_speech(points_bot, 'en')
